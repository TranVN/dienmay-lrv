                                            ...
                                            <div class="col-md-12 col-sm-12 already-registered-login">
                                                ...
                                                <form class="register-form" role="form" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control unicase-form-control text-input" value="name" id="name" name="name" required="required">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="email" readonly>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="info-title" for="Contact No.">Contact No. <span>*</span></label>
                                                        <input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" required="required" value="contactno" maxlength="10">
                                                    </div>
