                    ...
                    <div class="side-menu animate-dropdown outer-bottom-xs">
                        <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Sub Categories</div>        
                            <nav class="yamm megamenu-horizontal" role="navigation">
                                <ul class="nav">
                                    <li class="dropdown menu-item"><a href="/sub-category" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i></li>
                                </ul>
                            </nav>
                        </div>
                    </div><!-- /.side-menu -->
                                    ...
                                    <div class="accordion">
                                        <div class="accordion-group">
                                            <div class="accordion-heading">
                                                <a href="/category"  class="accordion-toggle collapsed"></a>
                                            </div>  
                                        </div>
                                    </div>
			                            ...
			                            <div class="products">				
	                                        <div class="product">		
		                                        <div class="product-image">
                                                    <div class="image">
                                                        <a href="/product-details"><img  src="https://www.dienmaythoviet.com/wp-content/uploads/2021/11/15L-2-1-200x243.png" data-echo="https://www.dienmaythoviet.com/wp-content/uploads/2021/11/15L-2-1-200x243.png" alt="" width="200" height="300"></a>
                                                    </div><!-- /.image -->			                      		   
		                                        </div><!-- /.product-image -->
					                            ...
					                            <div class="cart clearfix animate-effect">
                                                    <div class="action">
                                                        <ul class="list-unstyled">
                                                            ...
                                                            <li class="lnk wishlist">
                                                                <a class="add-to-cart" href="/category" title="Wishlist">
                                                                    <i class="icon fa fa-heart"></i>
                                                                </a>
                                                            </li>
                                                        </ul>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
			                            <div class="products">				
	                                        <div class="product">		
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="/product-details">Sản Phẩm</a></h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description">Thông tin sản phẩm</div>
                                                    <div class="product-price">	
                                                        <p class="price">Giá tiết kiệm: 1.000.000đ</p>
