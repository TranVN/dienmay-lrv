	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li><a href="#">Ten san pham</a></li>
				<li><a href="#">Thong tin san pham</a></li>
				<li class='active'><a href="#">Ten san pham</a></li>
			</ul>
                            ...
                            <div class="item">
                                <div class="products">
                                    <div class="hot-deal-wrapper">
                                        <div class="image">
                                            <img src="https://www.dienmaythoviet.com/wp-content/uploads/2022/06/Dieu-hoa-Casper-HC-09IA32-1-600x338-1.jpg"  width="200" height="334" alt="">
                                        </div>
                                    </div><!-- /.hot-deal-wrapper -->
                                    <div class="product-info text-left m-t-20">
                                        <h3 class="name"><a href="product-details.php">xin chao</a></h3>
                                        <div class="rating rateit-small">Xin chao</div>
                                    ...
                                    <div class="cart clearfix animate-effect">
                                        <div class="action">
                                            <div class="add-cart-button btn-group">
                                                ...
                                                <a href="product-details.php" class="lnk btn btn-primary">Add to cart</a>
                                            </div>
                                        </div><!-- /.action -->
                                    </div><!-- /.cart -->
                                </div>	
    					...
    					<div class="product-item-holder size-big single-product-gallery small-gallery">
							<div id="owl-single-product">
								<div class="single-product-gallery-item" id="slide1">
									<a data-lightbox="image-1" data-title="" href="#">
										<img class="img-responsive" alt="" src="{{asset('assets/images/blank.gif')}}" data-echo="https://www.dienmaythoviet.com/wp-content/uploads/2022/06/Dieu-hoa-Casper-HC-09IA32-1-600x338-1.jpg" width="370" height="350" />
									</a>
            					</div>
								<div class="single-product-gallery-item" id="slide1">
									<a data-lightbox="image-1" data-title="" href="#">
								...
								<div class="single-product-gallery-item" id="slide2">
									<a data-lightbox="image-1" data-title="Gallery" href="#">
										<img class="img-responsive" alt="" src="{{asset('assets/images/blank.gif')}}" data-echo="https://www.dienmaythoviet.com/wp-content/uploads/2022/06/Dieu-hoa-Casper-HC-09IA32-1-600x338-1.jpg" />
									</a>
								</div><!-- /.single-product-gallery-item -->
                            ...
                            <div class="single-product-gallery-thumbs gallery-thumbs">
                                <div id="owl-single-product-thumbnails">
                                    ...
                                    <div class="item">
                                        ...
                                        <img class="img-responsive"  alt="" src="{{asset('assets/images/blank.gif')}}" data-echo="https://www.dienmaythoviet.com/wp-content/uploads/2022/06/Dieu-hoa-Casper-HC-09IA32-1-600x338-1.jpg" height = "200" />
                                        </a>
                                    </div>
					...
					<div class="product-info">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="favorite-button m-t-10">
										<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php">
						...
						<div class="quantity-container info-container">
							<div class="row">
								...
								<div class="col-sm-7">
									<a href="/product-details" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
								</div>
							</div><!-- /.row -->
									...
									<div class="product-reviews">
										<h4 class="title">Customer Reviews</h4>
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													<div class="review-title"><span class="summary">summary</span><span class="date"><i class="fa fa-calendar"></i><span></span></span></div>
													<div class="text">"review"</div>
													<div class="text"><b>Quality :</b>quality Star</div>
													<div class="text"><b>Price :</b>priceStar</div>
													<div class="text"><b>value :</b> Star</div>
                                                	<div class="author m-t-15"><i class="fa fa-pencil-square-o"></i> <span class="name">name</span></div>
												</div>
									</div><!-- /.product-reviews -->
				...
				<div class="products">
					<div class="product">
						<div class="product-image">
							<div class="image">
								<a href="/product-details"><img  src="{{asset('assets/images/blank.gif')}}" data-echo="https://www.dienmaythoviet.com/wp-content/uploads/2022/06/Dieu-hoa-Casper-HC-09IA32-1-600x338-1.jpg" width="150" height="240" alt=""></a>
							</div><!-- /.image -->			
						</div><!-- /.product-image -->
					...
					<div class="action">
						<ul class="list-unstyled">
							<li class="add-cart-button btn-group">
								...
								<a href="/product-details" class="lnk btn btn-primary">Add to cart</a>
							</li>
						</ul>
					</div><!-- /.action -->
				</div><!-- /.cart -->
