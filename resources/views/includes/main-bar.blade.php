...
<a href="/">
    ...
    <h2>
        <div class="item">
                <a href="/" class="image">
                    <img data-echo="https://www.dienmaythoviet.com/wp-content/uploads/2020/04/logo-R-1-new-2.png" src="https://www.dienmaythoviet.com/wp-content/uploads/2020/04/logo-R-1-new-2.png" alt="" width="150px", height="81px">
                </a>	
    </h2>
        ...
        <li>
            <div class="cart-item product-summary">
                <div class="row">
                    <div class="col-xs-4">
                        <div class="image">
                            <a href="detail.html"><img  src="admin/productimages" width="35" height="50" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xs-7">
                        
                        <h3 class="name"><a href="index.php?page-detail">productName</a></h3>
